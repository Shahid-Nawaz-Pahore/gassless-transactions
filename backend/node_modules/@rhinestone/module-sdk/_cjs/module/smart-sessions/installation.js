...
const getSmartSessionsValidator = ({ sessions, useRegistry = true, hook, }) => {
    return {
        ...
        module: constants_1.SMART_SESSIONS_ADDRESS,
...
const getSmartSessionsCompatibilityFallback = () => {
    return {
        address: constants_1.SMART_SESSIONS_COMPATIBILITY_FALLBACK_ADDRESS,
        module: constants_1.SMART_SESSIONS_COMPATIBILITY_FALLBACK_ADDRESS,
        initData: '0x',
        deInitData: '0x',
        selector: '0x84b0196e',
