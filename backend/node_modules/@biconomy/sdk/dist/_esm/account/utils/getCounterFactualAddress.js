import { MOCK_ATTESTER_ADDRESS, RHINESTONE_ATTESTER_ADDRESS, k1ValidatorFactoryAddress } from "../../constants/index.js";
/**
 ...
 * ```
 */
export const getCounterFactualAddress = async (publicClient, signerAddress, isTestnet = false, index = 0n, attesters = [RHINESTONE_ATTESTER_ADDRESS], threshold = 1, factoryAddress = k1ValidatorFactoryAddress) => {
    if (isTestnet) {
