 ...
 */
export type UsePermissionModuleParameters = Omit<ModuleParameters, "accountAddress" | "address"> & {
 ...
 */
export declare const toSmartSessionsValidator: (parameters: UsePermissionModuleParameters) => SmartSessionModule;
