...
export declare const biconomySponsoredPaymasterContext: {
    mode: string;
    expiryDuration: number;
    calculateGasLimits: boolean;
    sponsorshipInfo: {
...
export declare const toBiconomyTokenPaymasterContext: (params: ToBiconomyTokenPaymasterContextParams) => PaymasterContext;
/**
