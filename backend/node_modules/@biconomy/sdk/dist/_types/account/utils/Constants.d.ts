...
export declare const MAGIC_BYTES = "0x6492649264926492649264926492649264926492649264926492649264926492";
export declare const BICONOMY_TOKEN_PAYMASTER = "0x00000000301515A5410e0d768aF4f53c416edf19";
export declare const DEFAULT_BICONOMY_IMPLEMENTATION_ADDRESS = "0x8EBDcA5ce92f9aBF1D1ab21de24068B2a2EaF808";
...
export declare const EXECTYPE_DEFAULT = "0x00";
export declare const EXECTYPE_TRY = "0x01";
export declare const EXECTYPE_DELEGATE = "0xFF";
export declare const MODE_DEFAULT = "0x00000000";
export declare const UNUSED = "0x00000000";
export declare const MODE_PAYLOAD = "0x00000000000000000000000000000000000000000000";
export declare const GENERIC_FALLBACK_SELECTOR = "0xcb5baf0f";
export declare const SENTINEL_ADDRESS: Hex;
export declare const MODE_VALIDATION = "0x00";
export declare const MODE_MODULE_ENABLE = "0x01";
...
export declare const NEXUS_DOMAIN_VERSION = "1.0.0";
...
export declare const PARENT_TYPEHASH = "TypedDataSign(Contents contents,bytes1 fields,string name,string version,uint256 chainId,address verifyingContract,bytes32 salt,uint256[] extensions)Contents(bytes32 stuff)";
