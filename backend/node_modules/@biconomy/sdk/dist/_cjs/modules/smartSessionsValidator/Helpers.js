...
const isPermissionEnabled = async ({ client, accountAddress, permissionId }) => {
...
const getTrustedAttesters = async ({ accountAddress, client }) => {
    try {
        const attesters = (await client.readContract({
            address: constants_1.REGISTRY_ADDRESS,
            abi: abi_1.ERC7484RegistryAbi,
