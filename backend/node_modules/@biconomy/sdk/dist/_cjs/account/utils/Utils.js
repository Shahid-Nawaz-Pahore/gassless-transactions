...
exports.getAllowance = exports.safeMultiplier = exports.isTesting = exports.playgroundTrue = exports.getAccountDomainStructFields = exports.eip712WrapHash = exports.getAccountMeta = exports.wrapSignatureWith6492 = exports.addressEquals = exports.isValidRpcUrl = exports.isNullOrUndefined = void 0;
...
const getAllowance = async (client, accountAddress, tokenAddress) => {
    const approval = await client.readContract({
        address: tokenAddress,
        abi: viem_1.erc20Abi,
        functionName: "allowance",
        args: [accountAddress, Constants_1.BICONOMY_TOKEN_PAYMASTER]
    });
    return approval;
};
